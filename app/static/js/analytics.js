(function () {
    ...
    var O = window, M = document, Mc = function () {
    ...
    var oc = function () {
        ...
        1 <= 100 * Math.random() || Aa("?") || (a = ["t=error", "_e=" + a, "_v=j39", "sr=1"], b && a.push("_f=" + b), c && a.push("_m=" + K(c.substring(0, 100))), a.push("aip=1"), a.push("z=" + fe()), wc(oc() + "/collect", a.join("&"), ua))
    };
    var Ha = function () {
        this.M = []
    };
