...
(function () {
    ...
    var u = {
        ...
        t3: 0,
        t4: 0
    }, y = ["search!"], ga = 3, ha = "BAIDU_DUP_replacement", ia = "http://dup.baidustatic.com/painter/", z = document, C = {}, ja = 0, ka = 1, D = 2, E = 3, F = 4, la = 5;

    function ma(a) {
        var b = na(a), d = b[0], b = b[1];
        this.id = a;
        this.name = b;
        this.uri = G(b);
        this.Fa = !b;
    ...
    function L(a, b, d) {
        var c = a.length;
        if (0 === c)b(); else for (var k = c, g = 0; g < c; g++)(function (a) {
            function h() {
                if (a.status < D)j(); else {
    ...
    function na(a) {
        ...
        -1 < d && (b = a.slice(0, d), a = a.slice(d + 1, a.length));
        return [b, a]
    }
    ...
    R("util/lang", [], function () {
        ...
        return {
            B: b, b: a, getAttribute: function (a, c) {
    ...
    R("util/browser", ["util/lang"], function (a) {
        var b = {}, d = navigator.userAgent, c = window.RegExp;
    ...
    R("util/style", ["util/lang", "util/dom", "util/browser"], function (a, b, d) {
        function c(a, j) {
            if (!a)return "";
            var c = "", c = -1 < j.indexOf("-") ? j.replace(/[-][^-]{1}/g, function (a) {
        ...
        function k(a) {
            var j = {top: 0, left: 0};
            if (a === b.j(a))return j;
            var d = b.va(a), e = d.body, d = d.documentElement;
        ...
        return {
            ...
            Za: g, O: function (a, c) {
                var d = b.c(a), e = d.offsetWidth;
                c && (e += g(d, "Left") + g(d, "Right"));
                return e
            }, N: function (a, c) {
                var d = b.c(a), e = d.offsetHeight;
                c && (e += g(d, "Top") + g(d, "Bottom"));
                return e
            }, $a: f, xa: function (a) {
                for (var c = b.c(a), a = b.A(c), c = f(c), d = 0; 10 > d++ && b.t(a) && !b.C(a);) {
                    var e = a.frameElement ? f(a.frameElement) : 100, c = c * (e / 100);
                    a = a.parent
                }
                return c
            }, da: function (a) {
    ...
    R("util/event", ["util/dom"], function (a) {
        return {
            bind: function (b, d, c) {
                if (b = a.Ga(b) ? b : a.c(b))if (b.addEventListener)b.addEventListener(d, c, r); else if (b.attachEvent)b.attachEvent("on" + d, c); else {
                    var k = b["on" + d];
                    b["on" + d] = function () {
    ...
    R("util/data", ["util/lang", "util/dom"], function (a, b) {
        ...
        var g = {}, f = b.M(), h = f.BAIDU_DUP_info || (f.BAIDU_DUP_info = {});
        return {
            m: function (a,
                         c) {
                var b = window;
                ...
                c[a] = m;
                return b
            }, f: d, d: c, ia: function (c, b) {
                var d = b ? h : g;
                switch (a.b(c)) {
                    case "string":
                        for (var f = c.split("."); f.length;) {
                            var l = f.shift();
                            if (f.length && d[l] !== m)d = d[l]; else return delete d[l], n
                        }
                }
                return r
            }, V: function (a, c, b) {
    ...
    R("util/storage", [], function () {
        ...
        return {
            qa: function () {
                ...
                return c
            }, setItem: a, getItem: b, ma: function (c, g, f) {
                if (d) {
                    g =
                ...
                if (d)if (g = f ? encodeURIComponent(g) : g, f = b(c) || "", f = f.replace(RegExp(g + "\\|?", "g"), "").replace(/\|$/, ""))try {
                    a(c, f)
                } catch (h) {
                } else d.removeItem(c)
            }
    ...
    R("util/log", ["util/lang", "util/event", "util/storage"], function (a, b, d) {
        function c(a, c) {
            var b = new Image, d = "BAIDU_DUP_log_" + Math.floor(2147483648 * Math.random()).toString(36);
            window[d] = b;
        ...
        return {
            Ha: c, gb: function () {
                var a = d.getItem(k);
                if (a)for (var a = a.split("|"), b = 0, h = a.length; b < h; b++)c(decodeURIComponent(a[b]), d.la)
            }, H: function (g) {
                var g = "object" === a.b(g) ? g : {}, f = g.url ||
                    "http://cbjslog.baidu.com/log", h = g.option || "now", g = a.ja(g.data || {}), f = f + ((0 <= f.indexOf("?") ? "&" : "?") + g + (g ? "&" : "") + "rdm=" + +new Date);
                switch (h) {
                    case "now":
                        c(f);
                        break;
    ...
    R("util", "util/lang,util/dom,util/style,util/url,util/event,util/cookie,util/data,util/storage,util/log,util/browser".split(","), function (a, b, d, c, k, g, f, h, j, i) {
        return {lang: a, a: b, style: d, url: c, event: k, cookie: g, data: f, jb: h, log: j, J: i}
    });
    R("biz", ["util", "slot"], function (a, b) {
        ...
        function c(c, b, d) {
            ...
            var d = d || {
                    ...
                    fa: r,
                    ha: r
                }, i = d.fa ? a.data.d(k) : {}, e = d.U ? g : k, i = d.ha ? {} : a.data.d(e) || i, d = {}, o;
            for (o in i)a.lang.B.call(i, o) && (d[o] = "array" === a.lang.b(i[o]) ? i[o].slice() : i[o]);
            var i = d[c] || [], l = b.length;
            for (o = 0; o < l; o++) {
                var p = b[o];
        ...
        var k = "bizOrientations", g = "bizUrgentOrientations";
        return {
            W: function (a, b) {
                ...
                var j = d.apply(this, arguments);
                return c(a, j, {U: n, fa: n})
            }, Sa: function (a, b) {
                var j = d.apply(this, arguments);
                return c(a, j, {U: n, ha: n})
            }, ya: function (c) {
                var c = Math.max(0, Math.min(c || 500, 500)), b = [], d = a.data.d(g) || a.data.d(k) || {};
                if ("object" === a.lang.b(d))for (var i in d)a.lang.B.call(d, i) && (b[b.length] = i +
                    "=" + d[i].join(","));
                a.data.f(g, m);
                b.sort(function (a, c) {
    ...
    R("preview", ["biz", "util"], function (a, b) {
        function d() {
            ...
            var k = b.url.P(), g = a("sid"), f = a("mid"), h = a("vc"), j = +a("ts"), i = q;
            3E4 >= +new Date - j && (i = {ka: g, Ja: f, Va: h});
            d = function () {
                return i
            };
            return i
    ...
    R("slot", ["util"], function (a) {
        ...
        function k(a, c, b) {
            ...
            if (o[a]) {
                ...
                if ("finish" === c) {
                    var c = {}, b = r, d;
                    for (d in p)if (d && p.hasOwnProperty(d) && p[d] &&
                        0 === ("" + a).indexOf("" + d) && o[a].response) {
                        var b = o[a].response.data, h = b._h || b.sh || b.height || 0;
        ...
        var j = "add,create,request,response,render,finish".split(","), i = [], e = {}, o = {}, l, p = {}, t = "BAIDU_DUP_wrapper_";
        return {
            add: function () {
                ...
                if (d(b, l)) {
                    ...
                    var j = document.getElementsByTagName("script"), t = j[j.length - 1];
                    if (t) {
                        var i = t.parentNode;
                        if (i) {
    ...
    R("param", ["slot", "preview", "biz", "util"], function (a, b, d, c) {
        ...
        var f = window, h = f.document, j = f.screen, i = f.navigator, e = +new Date, o = [{
            key: "di",
            value: function (a) {
                return k(a.id)
            }
        }, {key: "dcb", value: s("BAIDU_DUP_define")}, {key: "dtm", value: s("BAIDU_DUP2_SETJSONADSLOT")}, {
            key: "dbv",
            value: function () {
                var a = c.J;
            ...
            key: "dis", value: function () {
                ...
                c.a.t(f) && (a += 1);
                c.a.C(f, f.top) && (a += 2);
                var b = c.style.p(), d = c.style.o();
                if (40 > b || 10 > d)a += 4;
                return a
            }
        }, {
            key: "dai", value: function (c) {
        ...
        }, {key: "dvi", value: s("1442225175")}, {
            key: "ltu", n: n, value: function () {
                var a = c.url.P(function (a) {
                    var b =
                        c.style.p(a), a = c.style.o(a);
            ...
            key: "liu", n: n, value: function () {
                return c.a.t(f) ? h.URL : ""
            }
        }, {
            key: "ltr", n: n, value: function () {
                var a = c.a.M(), b = "";
                try {
            ...
            key: "lcr", n: n, value: function (a) {
                ...
                var a = h.referrer, b = a.replace(/^https?:\/\//,
                    ""), b = b.split("/")[0], b = b.split(":")[0], b = g(b), d = g(), e = c.cookie.get("BAIDU_DUP_lcr");
                if (e && d === b)return e;
                return d !== b ? (c.cookie.set("BAIDU_DUP_lcr", a, {domain: d}), a) : ""
            }
        }, {
            key: "ps", value: function (c) {
        ...
        },
            {
                ...
                key: "cfv", value: function () {
                    ...
                    if (0 === a && (f.ActiveXObject || f.hasOwnProperty("ActiveXObject")) && !f.opera)for (b = 30; 2 <= b; b--)try {
                ...
                key: "tpr", value: function (a) {
                    var a = a && a.max_age ? a.max_age : 24E4, c = (new Date).getTime(), b, d;
                    try {
                ...
                key: "coa", n: n, value: function (a) {
                    var a = a.id, b = {
                        cpro_w: "rsi0",
                        cpro_h: "rsi1"
                    }, a = a[0].split("_")[0], d = {}, h = r, e = c.data.d("#novaOpenApi");
                    if (e && a && e[a]) {
                        var h = n, e = e[a], f;
                        for (f in e)f && e.hasOwnProperty(f) && "undefined" !== typeof e[f] && (d[f] = encodeURIComponent(e[f]).toString())
                    }
                    h && (d.c01 = 1);
                    var h = f = "", j;
                ...
                key: "dpr", value: function () {
                    return window.devicePixelRatio || 1
                }
            }, {
                key: "ti", n: n, value: function () {
                    return c.a.$()
                }
            }, {
        ...
        return {
            get: function (a, b) {
                for (var c = [], d = 0, h = o.length; d < h; d++) {
                    var e;
                    try {
                        var f = o[d], j = f.key, g = f.n, i = f.value, i = "function" === typeof i ? i(a) : i, i = g ? encodeURIComponent(i) : i;
                        if (b && b === j)return i;
    ...
    R("request", ["param", "slot", "util"], function (a, b, d) {
        R("request!", [], {
            name2url: function (b) {
                return "http://cb.baidu.com/ecom?" + a.get({id: b.split(",")})
            }
        });
        R("batch!", [], {
            name2url: function (b) {
        ...
        return {
            send: function (a, k, g) {
                if (!a || !k || g === m)return r;
                var f = [];
                if ("array" !== d.lang.b(a))b.u(a, "request"), f = ["request!" + a]; else {
    ...
    R("control", ["slot", "request", "preview", "util"], function (a, b, d, c) {
        ...
        function g(d, f, g) {
            if (!d)return r;
            var g = g || "", e = a.add(d), d = e.ids[0] || e.preloadIds[0];
        ...
        return {
            fill: function (a) {
                ...
                var g = c.lang.l(arguments), g = c.lang.unique(g), i = d.d();
                if (i)for (var e = 0, k = g.length; e < k; e++)g[e] === i.ka && (g.splice(e, 1), e--);
    ...
    R("global", ["control", "biz", "util", "preview"], function (a, b, d, c) {
        ...
        function g() {
            ...
            if (!("object" === d.lang.b(a) && a.push)) {
                if ("array" === d.lang.b(a) && a.length)for (var b = 0; b < a.length; b++)f(a[b]);
                j.BAIDU_DUP = m;
                d.data.m("BAIDU_DUP", {push: f});
        ...
        function h() {
            function a(b) {
                for (var c = 0, d = y.length; c < d; c++)if (0 === b.indexOf(y[c]))return n;
                return r
            }
            ...
            d.data.m("BAIDU_DUP_define", function (b, c) {
                for (var d = 0, e = c.length; d < e; d++)if (a(c[d]))return;
                R.apply(q, arguments)
            })
        }
        ...
        var j = window, i = {
            ...
            i: ["fill"],
            g: a.fill
        }, {h: ["clb.fillSlotAsync"], i: ["fillAsync"], g: a.K}, {
            h: ["clb.preloadSlots"],
            i: ["preload"],
            g: a.Ma
        }, {h: ["clb.prepareMoveSlot"], i: ["prepareMove"], g: a.Na}, {
            h: ["clb.addOrientation"],
            i: ["addOrientation"], g: b.W
        }, {h: ["clb.addOrientationOnce"], i: ["addOrientationOnce"], g: b.na}, {
            ...
            i: [],
            g: d.lang.ga
        }, {h: ["dup.addSlotStatusCallback"], i: [], g: b.oa}], e = function (a) {
        ...
        return {
            Ea: function () {
                ...
                if (e)for (var f in e)Object.prototype.hasOwnProperty.call(e, f) && b.W(f, e[f]);
                d.data.f("#novaOpenApi", d.data.q("cproStyleApi"));
                var h = d.data.q("cproArray");
                if (h)for (var e = 0, j = h.length; e < j; e++)h[e] && h[e].id && a.K(h[e].id, "cpro_" + h[e].id);
                if (h = d.data.q("cpro_mobile_slot")) {
                    e = 0;
                    for (j = h.length; e < j; e++) {
                        var i = h[e], o = i.id, l = d.data.d("#novaOpenApi") || {};
                        l[o] || (l[o] = {});
    ...
    R("fingerprint", "util/log,util/storage,util/event,util/browser,util/data,param".split(","), function (a, b, d, c, k, g) {
        ...
        0 <= f.location.href.indexOf("wa.kuwo.cn") || (h && (k.d("isFPLoaded", n) === n ? h = r : k.f("isFPLoaded", n, n)), h && d.bind(f, "load", function () {
            var a = f.document, b = a.body, c = "http://pos.baidu.com/wh/o.htm?ltr=" + g.get({}, "ltr"), d = a.createElement("div");
    ...
    R("replacement", ["util"], function (a) {
        function b() {
            var d = a.url.P(), c = a.url.ba(d, ha, n);
            b = function () {
                return c
            };
            return c
    ...
    window.BAIDU_DUP_define && window.BAIDU_DUP_define("detect", ["api"], function (a) {
        ...
        try {
            setTimeout(function () {
                var c = a.getSlots(), d;
                for (d in c) {
                    var g = c[d], f = g.response, h = r;
                    if ("object" !== a.getType(f))h = n; else {
                        var h = n, j;
                        for (j in f)if (Object.prototype.hasOwnProperty.call(f, j)) {
                            h = r;
                            break
                        }
                    }
                    var i = g.status, g = g.stack;
                    h ? b({
    ...
    window.BAIDU_DUP_define && window.BAIDU_DUP_define("viewWatch", ["util", "param"], function (a, b) {
        function d() {
            var b = +new Date, d = 500;
            x === h && M && (d = b - M);
            M = b;
            for (var j in l)if (o.call(l, j)) {
                x === g && (x = f);
                var i = l[j];
                i.G && (i.R += d);
                i.F && (i.Q += d);
                i.S = b - i.timestamp;
                if (x === h)H && (i.w += b - i.D); else if (72E5 <= i.S)c(r); else {
                    var k = i = m, p = m;
                    for (p in l)if (o.call(l, p)) {
                        var w = l[p];
                        if (H) {
                            var v = a.a.c(w.Wa);
                            if (!v)break;
                            try {
                                var t = e.p(B), A = e.o(B), I = e.r(v);
                                w.top = I.top;
                                w.left = I.left;
                                var X = e.Ba(B), Y = e.Aa(B), Z = e.O(v), $ = e.N(v), aa = I.top -
                                    X + 0.35 * $, ba = I.left - Y + 0.35 * Z;
                                w.G = 0 < aa && aa < A && 0 < ba && ba < t;
                                var pa = Z * $, ca = e.r(v), N = ca.top - X, O = ca.left - Y, da = e.O(v), ea = e.N(v), fa = v = 0, v = 0 > N ? Math.max(N + ea, 0) : Math.min(ea, Math.max(A - N, 0)), fa = 0 > O ? Math.max(O + da, 0) : Math.min(da, Math.max(t - O, 0));
                                i = fa;
                                k = v;
                                w.F = k * i > 0.5 * pa
                            } catch (ra) {
        ...
        function c(b) {
            ...
            if (!(-1 < c.indexOf("autohome.com.cn") || -1 < c.indexOf("sina.com.cn") || -1 < c.indexOf("pconline.com.cn") || -1 < c.indexOf("pcauto.com.cn") || -1 < c.indexOf("pclady.com.cn") ||
                -1 < c.indexOf("pcgames.com.cn") || -1 < c.indexOf("pcbaby.com.cn") || -1 < c.indexOf("pchouse.com.cn") || -1 < c.indexOf("xcar.com.cn")))if (x !== f)x = h; else {
                x = h;
                d();
                var c = r, e;
                for (e in l)if (e && l.hasOwnProperty(e) && l[e]) {
                    var g = l[e];
                    "block" === g.Ia && (c = n);
                    g.total = p;
                    a.log.H({url: k(g)})
                }
                if (b && c)if (b = +new Date, j.s)for (c = b + 200; c > +new Date;); else {
                    e = 1E5;
                    for (c = 0; c < e; c++);
                    c = +new Date;
        ...
        var g = 1, f = 2, h = 3, j = a.J, i = a.event.bind, e = a.style, o = a.lang.B, l = [], p = 0, t = 0, x = g, H = n, M = 0, A = [1E4 < screen.availWidth ? 0 : screen.availWidth, 1E4 < screen.availHeight ? 0 : screen.availHeight].join(), B = window;
        a.a.t(window) && !a.a.C(window) && (B = window.top);
        t = setInterval(d, 500);
        (function () {
            function a() {
                var b = +new Date, c;
                for (c in l)if (o.call(l, c)) {
                    var d = l[c];
                    d.w +=
                        b - d.D;
                    d.D = b
        ...
        return {
            register: function (b) {
                var c = +new Date, d = b.id, f = b.wrapperId, g = b.url || "http://eclick.baidu.com/a.js?", h = b.logType || "storage", b = b.extra || "";
                if (f && !l[f]) {
                    var i = a.a.c(f);
                    if (i) {
                        var j = e.r(i);
